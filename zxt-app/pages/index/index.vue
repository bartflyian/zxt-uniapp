<template>
	<view class="container">
		...
		<!-- 课程与训练入口 -->
		<Enterpanel :panelTitle="'进阶课程'" :bgColor="'#0066ff'"></Enterpanel>
		<Enterpanel :panelTitle="'系统训练'" :bgColor="'#ffcc00'"></Enterpanel>
	</view>
</template>

<script>
	import Enterpanel from "../../components/enter-panel/enter-panel.vue"
	export default {
